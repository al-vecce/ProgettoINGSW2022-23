...
INSERT INTO Business(id, business_name, business_phone_number, business_address) VALUES (1, 'La%20Ratatouille', '3396036798', 'Via dei Topi (NA), 24b');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, second_name, second_ingredients, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(1,  1, 1, 'Pasta%20alla%20Genovese',    15, 'Manzo,Cipolle',            'GLUTINE',                   'Genovese%20Sauce%20Pasta', 'Beef,Onions',            false, '', '2020-06-06');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, second_name, second_ingredients, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(13, 2, 1, 'Risotto%20alla%20Pescatora', 20, 'Vongole,Gamberi,Calamari', 'PESCE,MOLLUSCHI,CROSTACEI', 'Seafood%20Risotto',      'Clams,Shrimps,Squids',   false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(9, 3, 1, 'Risotto%20allo%20Zafferano',  22, 'Cipolle,Brodo-Vegetale,Zafferano', 'LATTE', false, '', '2020-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(10, 5, 1, 'Zuppa%20di%20Ceci',          9,  'Ceci', 'GLUTINE', false, '', '2020-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(5, 7, 1, 'Pasta%20e%20Lenticchie',      8,  'Lenticchie', 'GLUTINE', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(7, 8, 1, 'Tagliatelle%20ai%20Funghi',   25, 'Porcini', 'GLUTINE', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(6, 9, 1, 'Ragù%20di%20Cinghiale',       28, 'Pomodoro,Cinghiale,Cipolle', 'GLUTINE', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(3, 10, 1, 'Pizza%20Margherita',         10, 'Pomodoro,Mozzarella,Basilico', 'GLUTINE,LATTE', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(4, 11, 1, 'Zuppa%20di%20Cozze',         11, 'Cozze', 'PESCE,MOLLUSCHI', false, '', '2020-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(3, 14, 2, 'Cotoletta%20di%20Pollo',     10, 'Pollo', 'GLUTINE', false, '', '1999-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(4, 15, 2, 'Salsicce%20di%20Cinghiale',  16, 'Cinghiale', '', false, '', '1998-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(5, 16, 2, 'Filetto%20di%20Scottona',    18, 'Manzo', '', false, '', '1998-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(10, 18, 2, 'Pulled%20Pork',             13, 'Maiale', '', false, '', '1999-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(9, 20, 2, 'Orata%20alla%20Brace',       17, 'Orata', 'PESCE', false, '', '1999-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(7, 22, 2, 'Gamberi%20Scottati',         21, 'Gamberi', 'CROSTACEI', false, '', '1999-11-03');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(1, 23, 2, 'Crocchette%20di%20Pollo',    8,  'Pollo', 'GLUTINE', true, '8008110121006', '1998-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(1, 26, 3, 'Mozzarella%20in%20Carrozza', 1,  'Mozzarella', 'GLUTINE,LATTE', true, '0074969051694', '2000-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(3, 29, 4, 'Sorbetto%20al%20Limone',     8,  'Limone', 'LATTE', false, '', '2020-06-05');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(2, 33, 5, 'Tagliere%20di%20Salumi',     11, '', '', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(3, 34, 5, 'Tagliere%20di%20Formaggi',   7,  '', 'LATTE,FRUTTAGUSCIO', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(4, 35, 5, 'Antipasto%20di%20Mare',      21, '', 'PESCE,MOLLUSCHI,CROSTACEI', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(1, 36, 5, 'Gnocco%20Fritto',            8,  '', 'GLUTINE', false, '', '2020-06-05');
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(1, 37, 6, 'CocaCola%20Zero',            2,  '','', true, '5000112556247', '2020-01-09');
...
INSERT INTO MenuElement(priority, id, menu_category_id, name, price, ingredients, allergens, openfoodfacts, openfoodfacts_identifier, last_modified) VALUES(4, 41, 6, 'Vino%20della%20Casa',        5,  '', '', false, '', '2023-04-22');
