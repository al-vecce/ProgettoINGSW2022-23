...
<form className="max-w-[18rem] mx-auto flex">
    <label for="currency-input" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Prezzo</label>
    <div className="relative w-full">
        <div classNameName="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
