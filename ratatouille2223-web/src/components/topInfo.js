...
export default function TopInfo() {
  ...
  return (
    ...
    bg-cover bg-center bg-[url('/header-splash.svg')] hue-rotate-[0deg] contrast-[1.25] saturate-[0.8]"
    style={{alignItems:'center'}}>
      <div className='w-full flex justify-between' style={{alignItems:'center'}}>
        ...
        <div className="body-font font-quicksand drop-shadow-lg font-semibold tracking-widest uppercase text-2xl lg:xl:text-4xl">Informazioni Attività</div>
